...
1. **Discovery phase** (before asking questions):
   ...
   e. Start memory with `neurox_session_start`, then call `neurox_context` and `neurox_recall` for past architectural decisions relevant to this task before any other context lookup
